...
export default function FeaturesBento() {
  return (
    <section className="overflow-x-hidden w-full max-w-full py-24 md:py-40 bg-[#0d0906]" aria-label="Features">
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 auto-rows-min grid-flow-dense">
          {/* Large hero card — span 2 cols, 2 rows */}
          <a href="/rng" className="group relative col-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-3xl bg-gradient-to-br from-[#1a120b] to-[#2d1e14] border border-[#f4d5ad]/10 hover:border-[#e09f58]/30 transition-all duration-700">
          ...
          <a href="/rng" className="group relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#1a120b] to-[#0d0906] border border-[#f4d5ad]/10 hover:border-[#e09f58]/30 transition-all duration-700">
